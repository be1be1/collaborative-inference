...
#     # Create modetorchl
#     # im = torch.zeros((1, 3, 256, 256)).to("cuda")
#
#
#     #
    model = Model("/home/zjlab/wangds/OperatorStatistics/SourceCodeRefactor/dnn_models/yolov5x.yaml").to("cuda" if torch.cuda.is_available() else "cpu")
#     # y = model.forward(im)
#     # # print(y)
#     # # print(len(y))
#     # # stride = torch.tensor([256 / x.shape[-2] for x in y])
#     # # print([256 / x.shape[-2] for x in y])
...
# import re
# model = DetectionModel("/home/zjlab/wangds/OperatorStatistics/SourceCodeRefactor/dnn_models/yolov5x.yaml")
# model.eval()
# device = torch.device('cuda', 0) if torch.cuda.is_available() else torch.device("cpu")
# model.to(device)
# dump_input=torch.randn(size=(1,3,640,640)).to(device)
# cpu_times, gpu_times = [], []
# for i in range(10):
...
#         dump_output=model.forward(dump_input)
#
